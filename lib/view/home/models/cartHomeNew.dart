...
HomeCartModel homeCartModelFromJson(String str) =>
    HomeCartModel.fromJson(json.decode(str));
...
class HomeProduct {
  ...
  HomeProduct({
    ...
    required this.variantHomeProduct,
  ...
  factory HomeProduct.fromJson(Map<String, dynamic> json) => HomeProduct(
        ...
        variantHomeProduct: json["variant_product"],
  ...
  Map<String, dynamic> toJson() => {
        ...
        "variant_product": variantHomeProduct,
