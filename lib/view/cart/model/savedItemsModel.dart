...
class SavedItemModel {
  ...
  factory SavedItemModel.fromJson(Map<String, dynamic> json) => SavedItemModel(
        ...
        data: List<SavedItem>.from(
            json["data"].map((x) => SavedItem.fromJson(x))),
      );
...
class SavedItem {
  ...
  factory SavedItem.fromJson(Map<String, dynamic> json) => SavedItem(
        ...
        product: ProductSavedItem.fromJson(json["product"]),
      );
...
class ProductSavedItem {
  ...
  factory ProductSavedItem.fromJson(Map<String, dynamic> json) =>
      ProductSavedItem(
        id: json["id"],
